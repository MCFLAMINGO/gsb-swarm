...
const VERTICALS = {
  ...
  healthcare: {
    ...
    toolRoutes: [
      ...
      { pattern: /patient|clinic|hospital|doctor|physician|dental|pharmacy|health|optom|vision|physical.therap|urgent.care|walk.in|mental.health|counseling|rehab|specialist|dermatol|cardiol|oncol|orthoped|neurol|urol|gastro|endocrin|rheumatol|psychiatr|psycholog|therapist|chiropract|acupunct|med.spa|aestheti|cosmetic.surg|plastic.surg|weight.loss|sleep.center|imaging|radiol|mri|xray|blood.test|infusion|dialysis|wound.care|home.health|hospice|pediatri|obgyn|ob.gyn|gynecol|fertility|midwife|audiolog|hearing|speech.therap|occupational.therap|podiatr|pain.manag|spine|orthotic|prostheti|naturopath|functional.med|integrative|hormone|trt|iv.therapy/i,                                                                                                                          tool: 'local_intel_search',  params: (zip, q) => ({ query: extractCategory(q, 'healthcare'), zip, group: 'health' }) },
      // Catch-all: oracle narrative for any healthcare market question
      { pattern: /.*/,                                                                                                                                                                                                                                                          tool: 'local_intel_oracle',  params: (zip) => ({ zip }) },
    ],
    mcpPrompts: [
      { q: 'What dentists operate in Ponte Vedra Beach?', zip: '32082' },
      ...
      { q: 'What urgent care or walk-in clinics are in this market?', zip: '32082' },
      { q: 'What optometrists or vision care providers are in this area?', zip: '32082' },
      { q: 'What physical therapy or rehab centers operate in this ZIP?', zip: '32082' },
      { q: 'What chiropractors serve Ponte Vedra Beach?', zip: '32082' },
      { q: 'What dermatologists or skin care clinics are in this ZIP?', zip: '32082' },
      { q: 'What cardiologists or heart specialists are accessible in 32082?', zip: '32082' },
      { q: 'What orthopedic surgeons or sports medicine clinics operate here?', zip: '32082' },
      { q: 'What pediatricians serve families in Nocatee?', zip: '32081' },
      { q: 'What OB-GYN or womens health providers are in this area?', zip: '32082' },
      { q: 'Is there a specialist gap for neurology in this ZIP?', zip: '32082' },
      { q: 'What med spas or aesthetic clinics operate in Ponte Vedra?', zip: '32082' },
      { q: 'What weight loss or hormone therapy clinics are in this market?', zip: '32082' },
      { q: 'What imaging centers or MRI facilities serve this ZIP?', zip: '32082' },
      { q: 'What IV therapy or infusion clinics are in this area?', zip: '32082' },
      { q: 'What sleep centers or sleep medicine providers are nearby?', zip: '32082' },
      { q: 'What podiatrists or foot care specialists serve this ZIP?', zip: '32082' },
      { q: 'What acupuncture or integrative medicine practices are here?', zip: '32082' },
      { q: 'What speech therapy or occupational therapy providers are in Nocatee?', zip: '32081' },
      { q: 'What home health or hospice providers serve this market?', zip: '32082' },
      { q: 'What is the consumer profile for this area — affluent or budget-conscious patients?', zip: '32082' },
      { q: 'What psychiatrists or behavioral health providers are in this ZIP?', zip: '32084' },
      { q: 'What fertility clinics or reproductive medicine practices are nearby?', zip: '32082' },
      { q: 'What pain management or spine clinics operate in St Johns County?', zip: '32092' },
  ...
  construction: {
    ...
    mcpPrompts: [
      ...
      { q: 'What window or door replacement companies serve this area?', zip: '32082' },
      { q: 'What pest control or remediation businesses operate here?', zip: '32082' },
      { q: 'What masonry or concrete contractors are in Ponte Vedra?', zip: '32082' },
      { q: 'What foundation repair companies serve this ZIP?', zip: '32082' },
      { q: 'What fence or fencing companies operate in St Johns County?', zip: '32082' },
      { q: 'What irrigation or sprinkler system companies are here?', zip: '32082' },
      { q: 'What solar panel installers serve Nocatee and nearby ZIPs?', zip: '32081' },
      { q: 'What gutter installation or repair companies operate here?', zip: '32082' },
      { q: 'What drywall or insulation contractors serve this market?', zip: '32082' },
      { q: 'What pressure washing or power washing companies are in this ZIP?', zip: '32082' },
      { q: 'What paver or hardscape companies operate in Ponte Vedra Beach?', zip: '32082' },
      { q: 'What stucco or siding contractors serve this area?', zip: '32082' },
      { q: 'What deck or patio builders operate in 32082?', zip: '32082' },
      { q: 'What kitchen or bathroom remodel contractors are nearby?', zip: '32082' },
      { q: 'What screen room or sunroom builders serve St Johns County?', zip: '32092' },
      { q: 'What septic or drain companies operate in this area?', zip: '32086' },
      { q: 'What generator installation companies serve this market?', zip: '32082' },
      { q: 'What handyman services operate in Nocatee?', zip: '32081' },
...
function extractCategory(q, fallback) {
  const cats = {
    ...
    hvac: /hvac|air.condition/i, masonry: /mason|concrete|foundation/i,
    pool: /pool/i, fence: /fence|fencing/i, irrigation: /irrigat|sprinkler/i,
    solar: /solar/i, generator: /generator/i, pavers: /paver|hardscape/i,
    stucco: /stucco|siding/i, drywall: /drywall|insulation/i,
    gutters: /gutter/i, 'pressure washing': /pressure.wash|power.wash/i,
    deck: /deck|patio|pergola/i, 'screen room': /screen.room|sunroom/i,
    remodel: /kitchen.remodel|bath.remodel|remodel|cabinet|countertop/i,
    handyman: /handyman/i, septic: /septic|drain/i,
    specialist: /specialist|dermatol|cardiol|orthoped|neurol|urol|psychiatr|podiatr|pain.manag/i,
    'med spa': /med.spa|aestheti|cosmetic.surg|weight.loss|hormone|trt/i,
    chiropractor: /chiropract/i, acupuncture: /acupunct|integrative|naturopath/i,
    imaging: /imaging|mri|xray|radiol/i, 'iv therapy': /iv.therapy|infusion/i,
    'home health': /home.health|hospice/i, pediatric: /pediatri/i,
    'ob-gyn': /obgyn|ob.gyn|gynecol|fertility/i,
    'speech therapy': /speech.therap|occupational.therap/i,
    retail: /retail|store|shop/i,
  };
