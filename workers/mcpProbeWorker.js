...
const PERSONAS = [
  ...
  },
  {
    ...
    queries: [
      ...
      zip => `What masonry or concrete contractors operate in ${zip}?`,
      zip => `What pool builders serve the ${zip} market?`,
      zip => `Are there paver or hardscape companies operating in ${zip}?`,
      zip => `What fence or fencing companies are in ${zip}?`,
      zip => `Is there a solar panel installation gap in ${zip}?`,
      zip => `What irrigation or sprinkler system companies serve ${zip}?`,
      zip => `What screen room or sunroom builders are in ${zip}?`,
      zip => `What generator installation companies operate near ${zip}?`,
      zip => `What pressure washing companies serve the ${zip} market?`,
  ...
  },
  {
    ...
    queries: [
      ...
      zip => `What chiropractors serve the ${zip} market?`,
      zip => `Are there dermatologists in ${zip}?`,
      zip => `What med spas or aesthetic clinics operate in ${zip}?`,
      zip => `Is there a cardiologist gap in ${zip}?`,
      zip => `What mental health or counseling providers are in ${zip}?`,
      zip => `What physical therapy or rehab centers operate in ${zip}?`,
      zip => `Are there imaging centers or MRI facilities in ${zip}?`,
      zip => `What IV therapy or infusion clinics serve ${zip}?`,
    ],
  },
];
