 ...
 *   job_complete   — job marked done via REST /job/complete or MCP local_intel_confirm_completion
...
async function migrate() {
  ...
  await db.query(`
    CREATE TABLE IF NOT EXISTS fee_events (
      ...
      event_type   TEXT NOT NULL,          -- rfq_match | rfq_book | job_complete | order_complete
      business_id  TEXT,
 ...
 *
 * @param {Object} opts
 * @param {string} opts.event_type  — rfq_match | rfq_book | job_complete | order_complete
