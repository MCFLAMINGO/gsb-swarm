...
const CONCEPT_PROFILES = {
  ...
  QSR_DRIVE_BY: {
    ...
    factors: [
      ...
      { key: 'growth',          weight: 0.05, normFn: 'minmax', normParams: {}, label: 'Market Growth Score', source: 'worldModelWorker: QCEW + SunBiz + BPS' },
      { key: 'sig_wallet_rate', weight: 0.05, normFn: 'minmax', normParams: {}, label: 'Active Business Ecosystem (wallet rate)', source: 'businessSignalWorker: businesses.wallet coverage' }
    ]
  },
  ...
  GENERAL: {
    ...
    factors: [
      ...
      { key: 'growth',          weight: 0.20, normFn: 'minmax',     normParams: {}, label: 'Market Growth Score', source: 'worldModelWorker composite' },
      { key: 'psycho_index',    weight: 0.10, normFn: 'precomputed', normParams: {}, label: 'Psychographic Index (arts, golf, education, lifestyle)', source: 'OSM POI density + ACS educational attainment + ACS median age' },
      { key: 'sig_task_density', weight: 0.05, normFn: 'minmax',    normParams: {}, label: 'Business Actionability (task templates per business)', source: 'businessSignalWorker: business_tasks density' }
    ]
  }
