...
const CONCEPT_PROFILES = {
  ...
  DESTINATION_DINING: {
    ...
    hardFloors: [],
    factors: [
      { key: 'hhi',          weight: 0.40, normFn: 'minmax',   normParams: {}, label: 'Household Income (higher = better)', source: 'ACS median HHI' },
      { key: 'owner_occ',    weight: 0.20, normFn: 'minmax',   normParams: {}, label: 'Owner-Occupied Housing Rate', source: 'ACS owner occupancy' },
      ...
      { key: 'age_index',    weight: 0.05, normFn: 'minmax',   normParams: {}, label: 'Age Index (35-55 peak)', source: 'ACS median age' }
    ]
  },
  ...
  RETAIL_STRIP: {
    ...
    factors: [
      ...
      { key: 'growth',       weight: 0.20, normFn: 'minmax',   normParams: {}, label: 'Market Growth', source: 'worldModelWorker composite' }
    ]
  },
  ...
  GENERAL: {
    ...
    hardFloors: [],
    factors: [
      { key: 'growth',       weight: 0.35, normFn: 'minmax',   normParams: {}, label: 'Market Growth Score', source: 'worldModelWorker composite' },
