...
function getPool() {
  if (!_pool) {
    ...
    // Main server pool: 10 connections for search/MCP/routing responsiveness.
    // Workers are forked with DB_POOL_MAX=1 but most are fresh/sleeping — effective active connections ~5-8.
    // Real fix: PgBouncer transaction pooling (Railway add-on) — 1000 users through 10-15 real connections.
