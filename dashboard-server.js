...
app.get('/.well-known/mcp/server-card.json', (req, res) => {
  res.json({
    ...
    tools: [
      ...
      { name: 'local_intel_corridor',  description: 'Businesses along a named street corridor (e.g. A1A, Palm Valley Road).', inputSchema: { type: 'object', required: ['corridor'], properties: { corridor: { type: 'string', description: 'Street or corridor name', examples: ['A1A', 'Palm Valley Road', 'CR-210'] }, zip: { type: 'string', description: 'Optional ZIP filter' } } } },
