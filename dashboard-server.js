...
app.get('/.well-known/mcp/server-card.json', (req, res) => {
  res.json({
    serverInfo: {
      ...
      version: '1.1.0',
      description: 'Agentic business intelligence for St. Johns County FL (32081 + 32082). 18 MCP tools across 5 verticals. Composite NL query via local_intel_ask. Two payment rails: $0.01–$0.05/call USDC on Base (x402) or pathUSD on Tempo mainnet.'
    },
